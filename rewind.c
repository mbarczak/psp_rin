...
void print_rewind_debug_info(SETTING local, char *info) {
	printf("\nINFO TYPE : %s\n",info);
	printf("\tGlobal current rewind memory    - get_current_rewind_memory()     : %d bytes / %d kb / %.1f mb\n",
	       get_current_rewind_memory(local),byte2kb(get_current_rewind_memory(local)),byte2mb_asFloat(get_current_rewind_memory(local)));
	...
	printf("\tGlobal max avail. rewind memory - max_rewind_memory               : %d bytes / %d kb / %.1f mb\n",
	       max_rewind_memory,byte2kb(max_rewind_memory),byte2mb_asFloat(max_rewind_memory));
	...
	printf("\tRewind : user max memory amount - rewind_user_max_memory_ammount  : %d bytes / %d kb / %.1f mb\n\n",
	       local.rewind_user_max_memory_ammount,byte2kb(local.rewind_user_max_memory_ammount),byte2mb_asFloat(local.rewind_user_max_memory_ammount));
